    ...
    show_modal_dialog(
        {
            ...
            body: (
                <div className="modal-body">
                    <strong>
                        {arrfmt(_("This system is not connected to $0."),
                            <a href="http://cloud.redhat.com" target="_blank" rel="noopener">
...
export class InsightsStatus extends React.Component {
    constructor() {
        super();
        this.state = { };
        get_monotonic_start.then(start => this.setState({ monotonic_start: start }));
    ...
    render() {
        ...
        if (insights_timer.enabled) {
            ...
            let rule_info = null;
            if (last_upload_monitor.results && last_upload_monitor.results.reports) {
                rule_info = <span>{cockpit.format(_("($0 rule hits.)"),
                                                  last_upload_monitor.results.reports.length)}</span>
            }
